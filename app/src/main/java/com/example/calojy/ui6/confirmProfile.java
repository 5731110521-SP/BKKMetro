...
public class confirmProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        formName.setText(info0.name);
        formName.setTextColor(Color.BLACK);
        formID.setText(info0.id);
        formID.setTextColor(Color.BLACK);
        formMail.setText(info0.mail);
        formMail.setTextColor(Color.BLACK);
        formPhone.setText(info0.phone);
...
//            }
        ...
        findViewById(R.id.back0).setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                Intent loginIntent = new Intent(confirmProfile.this, login.class);
